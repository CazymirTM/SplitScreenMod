...
Based on [BmSDK](https://bmsdk.dev), a C# modding framework for the game built by the same creators as the split-screen mod. Leave a star on both repos if you have fun with this!
